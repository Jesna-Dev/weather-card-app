...
export default function Weather() {
  ...
  useEffect(() => {
    async function getWeather() {
      ...
      const res = await fetch('https://fcc-weather-api.glitch.me/api/current?lat=35&lon=139');
    ...
    if(loading) {
      ...
      return (
        ...
        <p style={{textTransform: 'uppercase', marginBottom: '0'}}><strong>Current Weather @ {city}</strong></p>
